package com.tistory.whitepaek.study;
...
import com.tistory.whitepaek.study.form.StudyDescriptionForm;
import com.tistory.whitepaek.tag.TagRepository;
import com.tistory.whitepaek.tag.TagService;
...
public class StudySettingsController {
    ...
    public String updateStudyPath(@CurrentAccount Account account, @PathVariable String path, @RequestParam String newPath, Model model, RedirectAttributes attributes) {
        Study study = studyService.getStudyToUpdateStatus(account, path);
    ...
    public String updateStudyTitle(@CurrentAccount Account account, @PathVariable String path, @RequestParam String newTitle, Model model, RedirectAttributes attributes) {
        Study study = studyService.getStudyToUpdateStatus(account, path);
