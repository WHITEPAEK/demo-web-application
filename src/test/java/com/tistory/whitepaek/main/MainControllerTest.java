...
class MainControllerTest {
    ...
    void beforeEach() {
        ...
        signUpForm.setNickname("whitepaek");
        signUpForm.setEmail("thewhitehope@naver.com");
    ...
    void login_with_email() throws Exception {
        mockMvc.perform(post("/login")
                        .param("username", "thewhitehope@naver.com")
                        .param("password", "12345678")
                        .with(csrf()))
                .andExpect(status().is3xxRedirection())
                .andExpect(redirectedUrl("/"))
                .andExpect(authenticated().withUsername("whitepaek"));
    }
